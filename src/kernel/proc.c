...
void init_(){
	...
	init->kstack[SSIZE-4] = 0x8;						// set cs
	init->kstack[SSIZE-3] = 0x200;	// set eflags
	init->kstack[SSIZE-2] = init->pid*0x10000-1+SPROC;	// set uesp
	init->kstack[SSIZE-1] = 0x10;						// set uss
	init->kstack[SSIZE-17] = 0x10;						// set ds
	init->kstack[SSIZE-18] = 0x10;						// set es
	init->kstack[SSIZE-19] = 0x10;						// set fs
	init->kstack[SSIZE-20] = 0x10;						// set gs
}
